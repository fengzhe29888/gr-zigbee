...
class frame_length_detector(object):
    ...
    def make(*args, **kwargs):
        """
        make(int const Q, pmt_vector_float symbol_table) -> frame_length_detector_sptr
...
def frame_length_detector_make(*args, **kwargs):
  """
    frame_length_detector_make(int const Q, pmt_vector_float symbol_table) -> frame_length_detector_sptr
...
class frame_length_detector_sptr(object):
    ...
    def make(self, *args, **kwargs):
        """
        make(frame_length_detector_sptr self, int const Q, pmt_vector_float symbol_table) -> frame_length_detector_sptr
